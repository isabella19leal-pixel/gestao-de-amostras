...
async function carregarTudo() {
  try {
    const [amostrasRes, basesRes, osContratoRes, contratoBaseRes, fretesRes] = await Promise.all([
      supabaseClient.from("amostras").select(
    ...
    for (const r of [amostrasRes, basesRes, osContratoRes, contratoBaseRes, fretesRes]) {
    ...
    const amostrasRaw = amostrasRes.data || [];
